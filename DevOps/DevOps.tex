...
% --------- Experience -----------
 \begin{experienceSection}{Professional Experience}
  ...
  across environments
    ...
    \begin{itemize}
        \itemsep -6pt {}
        \item Led migration of \textbf{500TB+} enterprise healthcare data from on-prem infrastructure to AWS using \textbf{Python} and \textbf{Bash} scripts and AWS \textbf{S3}, reducing storage costs by \textbf{30\%} while maintaining HIPAA compliance
...
\begin{experienceSection}{Academic Projects}
    ...
    \projectItem[
        title={End-to-end Deployment Automation | AWS, GitHub Actions, Jenkins, Ansible, Bash | \href{https://github.com/Ajtambad/Terraform-Ansible-Project}{GitHub}},
        duration={Apr 2025},
    ]
    \begin{itemize}
        \vspace{-0.5em}
        \itemsep -6pt {}
        \item Reduced deployment time by \textbf{90\%} by building a fully automated \textbf{CI/CD} pipeline integrating Terraform (infrastructure provisioning), \textbf{Ansible} (configuration management), and \textbf{Jenkins/GitHub Actions}
