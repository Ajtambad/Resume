...
\begin{skillsSection}{Skills}
    \skillItem[
        ...
        skills={Python, C++, Bash, Powershell, SQL (MySQL, Postgres), NoSQL (MongoDB), Go, JavaScript, Java}
    ] \\
    \skillItem[
        category={Tools and Frameworks},
        skills={AWS, Linux (RHEL, Ubuntu), Docker, Kubernetes, Nginx, Jenkins Flask, FastAPI, Node.js, Splunk, React, Angular, Github Actions, Terraform, Ansible, Git, Gitlab, Prometheus, Grafana, Zabbix, PyTorch, TensorFlow, Chef}
    ] \\
    \skillItem[
        category={Miscellaneous},
        skills={UNIX, Distributed Systems, RESTful APIs, Microservices Architecture, Object-Oriented Programming, Agile, SDLC, Infrastructure Management, Incident Response, Risk Management, Machine Learning, TCP/IP}
    ]
\end{skillsSection}
