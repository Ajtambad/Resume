...
% --------- Experience -----------
 \begin{experienceSection}{Professional Experience}
    ...
    \begin{itemize}
        \itemsep -6pt {}
        \item Engineered \textbf{Terraform} automation pipelines for \textbf{AWS} infrastructure provisioning, implementing security controls and best practices across multiple services like VPC, RDS, EC2, etc.
        \item Implemented gamification features for \textbf{Zip-E}, the shopping application, with \textbf{FastAPI} backend and \textbf{MySQL} database to increase user engagement and data collection through reward-based incentives
    \end{itemize}
