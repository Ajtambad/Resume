...
% --------- Experience -----------
 \begin{experienceSection}{Professional Experience}
    ...
    \begin{itemize}
        \itemsep -6pt {}
        \item Developed FlowBench, a distributed benchmarking framework using \textbf{Python}, \textbf{Docker}, and \textbf{Kubernetes} to evaluate edge computing applications, enabling performance comparison across 6+ metrics, including latency, throughput, and resource utilization for \textbf{FaaS} workloads
    \end{itemize}
    ...
    \begin{itemize}
        \itemsep -6pt {}
        \item Architected log filtering and routing pipelines using Cribl Stream for OpenShift Kubernetes clusters, reducing Splunk ingestion by 40-50 GB/day (\textbf{~\$46K annual savings} ) and improving search performance by \textbf{20\%}
...
\begin{experienceSection}{Academic projects}
    ...
    \begin{itemize}
        \vspace{-0.5em}
        \itemsep -6pt {}
        \item Engineered a scalable data pipeline using \textbf{Kubernetes}, \textbf{Apache Kafka}, and \textbf{Neo4j} to process \textbf{100,000+} NYC taxi records in near-real-time, reducing spatial query time by \textbf{60\%}
    \end{itemize}
