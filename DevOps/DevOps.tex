...
\begin{skillsSection}{Skills}
    ...
    \skillItem[
        ...
        skills={AWS (EC2, Lambda, S3, ECS, CloudFormation, EKS, ECR, CloudWatch), TensorFlow, Docker, Kubernetes, Helm, Terraform, Jenkins, Github Actions, GCP}
    ] \\
    \skillItem[
        category={Tools},
        skills={Linux (RHEL, Ubuntu), Unix, Git (Version Control), Bash, Github, Ansible, Chef, Gitlab, Prometheus, Grafana, Postman}
    ] \\
    \skillItem[
        category={Miscellaneous},
        skills={Distributed Systems, RESTful APIs, Microservices, Object Oriented Programming, Agile, Test Driven Development (TDD), Infrastructure as code (IaC), DevOps, Cloud Infrastructure, Collaboration, Writing}
    ]
\end{skillsSection}
