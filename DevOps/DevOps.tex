...
\begin{skillsSection}{Skills}
    ...
    \skillItem[
        ...
        skills={AWS, Linux (RHEL, Ubuntu), Docker, Kubernetes, PostmanAPI, Nginx, Gunicorn, Flask, FastAPI, Node.js, Zookeeper, Splunk, Github Actions, Terraform, Ansible, Git, Gitlab, Prometheus, Grafana, Jenkins, Cribl, Zabbix, Chef}
    ] \\
    \skillItem[
