...
\begin{skillsSection}{Skills}
    \skillItem[
        ...
        skills={Python, C++, Bash, SQL (Postgres, MySQL), NoSQL (MongoDB), Go, Scala, HTML, JavaScript, Java}
    ] \\
    \skillItem[
        category={Tools and Frameworks},
        skills={AWS, Linux, Kafka, PostmanAPI, Docker, Kubernetes, Nginx, Gunicorn, Kafka, React, Flask, FastAPI, Node.js, PyTorch, TensorFlow, Zookeeper, Splunk, Github Actions, Terraform, Ansible, Git, Gitlab, Prometheus, Grafana, Jenkins, Cribl, Zabbix, Chef}
    ] \\
    \skillItem[
